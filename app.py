...
def detail(keyword):
    ...
    if definitions is None:
        ...
        return not_found_error(suggestions)
...
def not_found_error(suggestions):
    return render_template('error.html', msg=f'Could not find the word, "{request.path[1:]}", did you mean one of these words: {suggestions}')
